...
<section class="home-section">
    <div class="container input">
        ...
        <form action="../controller/simpan_distributor.php" method="post">
            ...
            <label for="nama_distributor"><span>Nama Disiributor</span><input type="text" maxlength="30" size="30" name="nama_distributor" placeholder="Nama Disiributor" /></label>
