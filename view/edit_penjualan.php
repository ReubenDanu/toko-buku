...
<section class="home-section">
    <div class="container input">
        <div class="header">
            <span class="span">Edit Penjualan</span>
        </div>
        <form action="../controller/simpan_penjualan.php" method="post">
            ...
            <label for="id_user"><span>ID User</span><input type="text" maxlength="30" size="30" name="id_user" placeholder="ID User" value="<?php echo $id_user?>"/></label>
