...
<section class="home-section">
    <div class="container input">
        ...
        <form action="../controller/simpan_user.php" method="post">
            ...
            <label for="nama_user"><span>Nama User</span><input type="text" maxlength="30" size="30" name="nama_user" placeholder="Nama User" value="<?php echo $nama?>"/></label>
            ...
            <label for="username"><span>Username</span><input type="text" maxlength="30" size="30" name="username" placeholder="Username" value="<?php echo $username?>"/></label>
            <label for="password"><span>Password</span><input type="password" maxlength="30" size="30" name="password" placeholder="Password" value="<?php echo $password?>"/></label>
